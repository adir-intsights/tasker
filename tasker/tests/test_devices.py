...
class DevicesTestCase(
    ...
    def test_timeouts_local_killer(
        self,
    ):
        local_killer = devices.killer.LocalKiller(
            pid=os.getpid(),
    ...
    def test_timeouts_remote_killer(
        self,
    ):
    ...
    def test_sleep_case_local_killer(
        self,
    ):
    ...
    def test_no_int_case_local_killer(
        self,
    ):
        test_process_obj = TestProcess()
        testing_process = multiprocessing.Process(
    ...
    def test_sleep_case_remote_killer(
        self,
    ):
        test_process_obj = TestProcess()
        testing_process = multiprocessing.Process(
    ...
    def test_no_int_case_remote_killer(
        self,
    ):
        test_process_obj = TestProcess()
        testing_process = multiprocessing.Process(
    ...
    def test_lost_case_remote_killer(
        self,
    ):
        test_process_obj = TestProcess()
        testing_process = multiprocessing.Process(
